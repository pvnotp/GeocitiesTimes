...
- Create Angular project with ng: `ng new geocitiestimes.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`geocitiestimes.client.esproj`).
